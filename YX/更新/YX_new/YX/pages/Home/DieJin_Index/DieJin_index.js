  ...
  data: {
    list: [
      ...
      },
      {
        ...
        name: '生活指南',
        open: false,
        pages: ['水电相关','宿舍相关','网络相关','餐厅相关','洗浴相关','医疗相关','早起相关','快递相关'],
        url: ['/pages/DieJin/DJ_Water&Elect/dj_water&elect','/pages/DieJin/DJ_living/dj_living', '/pages/DieJin/DJ_Network/dj_network', '/pages/DieJin/DJ_Canteen/dj_canteen', '/pages/DieJin/DJ_Shower/dj_shower', '/pages/DieJin/DJ_Medical/dj_medical', '/pages/Life/Getup/getup','/pages/DieJin/DJ_Express/dj_express']
      }
    ],
