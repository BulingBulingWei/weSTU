  ...
  data: {
    list: [
      ...
      },
      {
        ...
        url: ['/pages/Life/Power/power','/pages/DieJin/DJ_living/dj_living', '/pages/DieJin/DJ_Network/dj_network', '/pages/DieJin/DJ_Canteen/dj_canteen', '/pages/Life/Shower/shower', '/pages/DieJin/DJ_Medical/dj_medical', '/pages/Life/Getup/getup','/pages/DieJin/DJ_Express/dj_express']
      }
    ],
